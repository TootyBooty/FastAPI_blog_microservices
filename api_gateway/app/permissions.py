...
from api.schemas.user import UserOutForLogin, UserShow, UserRole
...
def check_permissions(allowed_roles: set[UserRole],
    ...
    if bool(allowed_roles & current_user_roles):
        ...
        if (UserRole.ROLE_MODERATOR in target_user_roles) and (UserRole.ROLE_ADMIN not in current_user_roles):
            return False
